      ...
      return (
        <div className="min-h-screen bg-[#0B0C0E] text-white flex items-center justify-center p-6 font-sans">
          <div className="max-w-md w-full bg-[#12141C] border border-orange-500/30 rounded-2xl p-6 shadow-2xl text-center space-y-4">
            <div className="w-12 h-12 rounded-full bg-orange-500/10 border border-orange-500/30 text-[#FF5D00] flex items-center justify-center mx-auto">
            ...
            <button
              ...
              className="w-full bg-[#FF5D00] hover:bg-orange-600 text-white font-bold py-2.5 px-4 rounded-xl transition-all flex items-center justify-center gap-2"
            >
