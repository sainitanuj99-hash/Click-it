    ...
    case 'scooter-express':
      return (
        <svg viewBox="0 0 100 65" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Motion Lines */}
          <path d="M 4 24 H 14 M 2 32 H 10 M 6 40 H 16" stroke="#00a6c7" strokeWidth="2" strokeLinecap="round" opacity="0.7" />
          
          {/* Branded Delivery Parcel Box with 'C' Monogram */}
          <rect x="18" y="14" width="26" height="24" rx="3" fill="#00a6c7" />
          ...
          <path d="M 40 34 H 60 C 66 34 72 26 74 18 H 80" stroke="#00a6c7" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
    ...
    case 'three-wheeler':
      return (
        <svg viewBox="0 0 110 70" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Motion Lines */}
          <path d="M 4 28 H 12 M 2 38 H 10" stroke="#00a6c7" strokeWidth="2" strokeLinecap="round" opacity="0.6" />
          {/* Cargo Bed */}
          <rect x="18" y="20" width="48" height="28" rx="2" fill="#00a6c7" />
          ...
          <circle cx="34" cy="52" r="3.5" fill="#00a6c7" />
          <circle cx="88" cy="52" r="9" fill="#18181B" stroke="#71717A" strokeWidth="2" />
          <circle cx="88" cy="52" r="3.5" fill="#00a6c7" />
        </svg>
      );
    ...
    case 'tata-ace':
      return (
        <svg viewBox="0 0 115 70" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="16" y="16" width="56" height="34" rx="3" fill="#00a6c7" />
          ...
          <circle cx="36" cy="52" r="3.5" fill="#00a6c7" />
    ...
    case 'pickup-9ft':
      return (
        <svg viewBox="0 0 120 70" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="14" y="22" width="62" height="26" rx="2" fill="#00a6c7" />
          ...
          <circle cx="34" cy="50" r="4" fill="#00a6c7" />
          <circle cx="94" cy="50" r="10" fill="#18181B" stroke="#A1A1AA" strokeWidth="2" />
          <circle cx="94" cy="50" r="4" fill="#00a6c7" />
        </svg>
      );
    ...
    case 'container-19ft':
      return (
        <svg viewBox="0 0 130 75" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="12" y="12" width="74" height="42" rx="4" fill="#00a6c7" />
    ...
    default:
      return (
        <svg viewBox="0 0 140 75" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="8" y="10" width="88" height="44" rx="4" fill="#00a6c7" />
